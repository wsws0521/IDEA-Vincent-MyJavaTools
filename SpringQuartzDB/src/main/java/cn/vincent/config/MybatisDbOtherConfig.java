...
@Configuration
@MapperScan(basePackages = "cn.vincent.dao.other", sqlSessionFactoryRef = "otherSqlSessionFactory")
public class MybatisDbOtherConfig {
    ...
    public SqlSessionFactory basicSqlSessionFactory(@Qualifier("otherDataSource") DataSource basicDataSource) throws Exception {
        ...
        factoryBean.setMapperLocations(
                new PathMatchingResourcePatternResolver().getResources("classpath:cn/vincent/dao/other/*.xml"));
