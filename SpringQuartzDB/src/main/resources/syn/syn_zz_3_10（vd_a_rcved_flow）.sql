DROP PROCEDURE IF EXISTS syn_zz_3_10;
delimiter $$
CREATE PROCEDURE syn_zz_3_10()(OUT `error_code` integer, OUT `error_msg` text)
...
BEGIN
    ...
    FROM tmp_sdjl sdjl
    INNER JOIN vd_a_rcvbl_flow rcvblflow ON sdjl.ORDERSID = rcvblflow.orderid
