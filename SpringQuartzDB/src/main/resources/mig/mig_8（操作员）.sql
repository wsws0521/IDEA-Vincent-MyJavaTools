...
BEGIN
	...
	DECLARE var_userId INTEGER DEFAULT NULL; 		/* 操作员id序列 */
	DECLARE var_userRoleId INTEGER DEFAULT NULL; 	/* 操作员权限关系id序列 */
    ...
    # 增大email字段长度（后期由王良柏修改ddl脚本）（后来发现又他妈变成32了，而且明明是字段长度溢出，存储过程居然报：）
	...
	UPDATE uap_sequence SET next_val = 200001 WHERE sequence_name = 'userRoleId';
	...
	UPDATE uap_sequence SET next_val = 200001 WHERE sequence_name = 'userId';
	# 开始循环
	REPEAT
