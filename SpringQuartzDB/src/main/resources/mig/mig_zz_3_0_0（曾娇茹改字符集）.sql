...
WHERE T.TABLE_SCHEMA=DATABASE()
  AND t.TABLE_TYPE='BASE TABLE'
	AND (T.TABLE_COLLATION IN ('utf8_bin','utf8_general_ci')
	     OR (T.TABLE_COLLATION NOT IN ('utf8_bin','utf8_general_ci')
			     AND t.TABLE_COLLATION <> (SELECT t.DEFAULT_COLLATE_NAME FROM information_schema.CHARACTER_SETS t WHERE t.CHARACTER_SET_NAME='utf8mb4'))));
...
WHERE a.TABLE_SCHEMA=DATABASE()
  ...
  AND (T.CHARACTER_SET_NAME='utf8'
	     or (T.CHARACTER_SET_NAME='utf8mb4' AND T.COLLATION_NAME <> 'utf8mb4_bin' and t.COLLATION_NAME <> (SELECT t.DEFAULT_COLLATE_NAME FROM information_schema.CHARACTER_SETS t WHERE t.CHARACTER_SET_NAME='utf8mb4'))));
    DECLARE CONTINUE HANDLER FOR NOT FOUND SET DONE = TRUE;
    OPEN TAB_CURSOR;
      TABLOOP: LOOP
