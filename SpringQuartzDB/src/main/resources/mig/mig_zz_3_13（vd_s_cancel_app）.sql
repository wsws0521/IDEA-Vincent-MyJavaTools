...
BEGIN
    ...
    LEFT JOIN vd_a_pay_flow_2015 flownormal ON sdjl.ORDERSID = flownormal.orderid AND flownormal.CHARGE_REMARK = 'migrate normal'
    LEFT JOIN vd_a_inv_2015 invnormal ON flownormal.charge_id = invnormal.chargeid
    LEFT JOIN vd_a_pay_flow_2015 flowreversal ON sdjl.ORDERSID = flowreversal.orderid AND flowreversal.CHARGE_REMARK = 'migrate reversal'
    LEFT JOIN vd_a_inv_2015 invreversal ON flowreversal.charge_id = invreversal.chargeid
