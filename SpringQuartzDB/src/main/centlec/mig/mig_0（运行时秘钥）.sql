...
BEGIN
	...
	SELECT '2', '3', '01', '02', '89053508', '192.168.81.2-SM1', '', NULL, NULL, '2', NULL, NULL, NULL, '02', '10000', SYSDATE(), '10', NULL, NULL
	FROM DUAL;
	INSERT INTO `d_ebox` (`LESSEE_ID`, `EBOX_ID`, `FACTURER_ID`, `STS`, `EBOX_NO`, `NAME`, `ASSET_NO`, `HARDWARE_ID`, `FIRMWARE_NO`, `BOX_TYPE`, `BAR_CODE`, `MADE_NO`, `MADE_DATE`, `DOC_TYPE_CODE`, `DOC_CREATOR_NO`, `DOC_CREATE_DATE`, `CUR_STATUS_CODE`, `ERP_BATCH_NO`, `REMARK`)
	SELECT '2', '4', '01', '02', '89053502', 'SM3', NULL, 'Prism-TSM500-4', 'STS64V10', '2', NULL, NULL, NULL, '02', '10000', SYSDATE(), '10', NULL, NULL
	FROM DUAL;
	INSERT INTO `d_ebox` (`LESSEE_ID`, `EBOX_ID`, `FACTURER_ID`, `STS`, `EBOX_NO`, `NAME`, `ASSET_NO`, `HARDWARE_ID`, `FIRMWARE_NO`, `BOX_TYPE`, `BAR_CODE`, `MADE_NO`, `MADE_DATE`, `DOC_TYPE_CODE`, `DOC_CREATOR_NO`, `DOC_CREATE_DATE`, `CUR_STATUS_CODE`, `ERP_BATCH_NO`, `REMARK`)
	SELECT '2', '5', '01', '02', '89053499', '192.168.81.3-SM2', NULL, NULL, NULL, '2', NULL, NULL, NULL, '02', '10000', SYSDATE(), '10', NULL, NULL
	FROM DUAL;
	...
	SELECT '2', '3', '2', '10', NULL, NULL, NULL, NULL, 1, NULL, NULL
	FROM DUAL;
	INSERT INTO `vd_p_ebox_run` (`LESSEE_ID`, `EBOX_ID`, `THIRD_PARTY_ID`, `STATUS`, `TOKEN_NUM`, `TOKEN_ALARM`, `VK_ALARM`, `VK_ALARM_UNIT`, `PRIORITY`, `LIC_ALARM`, `LIC_ALARM_UNIT`)
	SELECT '2', '4', '2', '20', NULL, NULL, NULL, NULL, 3, NULL, NULL
	FROM DUAL;
	INSERT INTO `vd_p_ebox_run` (`LESSEE_ID`, `EBOX_ID`, `THIRD_PARTY_ID`, `STATUS`, `TOKEN_NUM`, `TOKEN_ALARM`, `VK_ALARM`, `VK_ALARM_UNIT`, `PRIORITY`, `LIC_ALARM`, `LIC_ALARM_UNIT`)
	SELECT '2', '5', '2', '20', NULL, NULL, NULL, NULL, 2, NULL, NULL
	FROM DUAL;

	# 4-更新STS2加密服务地址，去除加密服务名称中的中文
	UPDATE P_THIRD_PARTY SET INTERFACE_URL = 'http://192.168.81.8:8010/EncrptionService/rest/sts' WHERE BUSINESS_TYPE = '0402';
	UPDATE P_THIRD_PARTY SET THIRD_PARTY_NAME = 'STS2' WHERE BUSINESS_TYPE = '0402';
