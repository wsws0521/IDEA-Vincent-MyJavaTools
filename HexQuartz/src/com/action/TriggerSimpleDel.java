...
public class TriggerSimpleDel extends ActionSupport{
	...
	public String execute() throws Exception {
		...
		if(result){out.print("<script language='javascript'>alert('删除成功！');window.location='TriggerSimpleManager.action';</script>");
		out.flush();out.close();return null;}
		return SUCCESS;		
	}
