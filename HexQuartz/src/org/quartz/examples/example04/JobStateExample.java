...
public class JobStateExample {
  ...
  public void run() throws Exception {
    ...
    JobDetail job1 = newJob(ColorJob.class).withIdentity("job1", "group10").build();
    ...
    JobDetail job2 = newJob(ColorJob.class).withIdentity("job2", "group10").build();
