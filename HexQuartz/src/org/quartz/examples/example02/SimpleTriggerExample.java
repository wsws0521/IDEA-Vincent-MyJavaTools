...
public class SimpleTriggerExample {
	...
	// simpleTrigger存档数据库
	//[SIMPLE_TRIGGERS]
	//[FIRED_TRIGGERS]存放执行过程中的trigger，执行结束清空
	//[JOB_DETAILS]【"job1", "group1"】主键不能重复
	//[TRIGGERS]
...
//job7:20/5min（scheduler启动之后）
    ...
    log.info(job.getKey() + " will run at: " + ft + " and repeat: " + trigger.getRepeatCount() + " times, every "
             + trigger.getRepeatInterval() / 1000 + " seconds");
  //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //job8:20/5min（scheduler启动之后，无需新建trigger）
