...
public class StdSchedulerFactory implements SchedulerFactory {
     ...
     * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
     */
	//wswsĬ��ȡ����Ŀ¼�µ�quartz.properties������������ȡorg/quartz�ļ����µ�quartz.properties ��370�У�
    ...
    public void initialize() throws SchedulerException {
      ...
      //wswsĬ��ȡ����Ŀ¼�µ�quartz.properties������������ȡorg/quartz�ļ����µ�quartz.properties
    ...
    private Scheduler instantiate() throws SchedulerException {
        ...
        DBConnectionManager dbMgr = null;//wsws ���ݿ������
        ...
        try {        	
            tp = (ThreadPool) loadHelper.loadClass(tpClass).newInstance();//wsws:load threeadPool class success!
        } catch (Exception e) {
        ...
        for (int i = 0; i < dsNames.length; i++) {//wsws properties��ֻ��һ��sampDS����ֻѭ��һ��
            ...
            if(cpClass != null) {
                ...
                if (dsJndi != null) {
                    ...
                    try {
                        PoolingConnectionProvider cp = new PoolingConnectionProvider(pp.getUnderlyingProperties());//wsws initializing and [info]
                        dbMgr = DBConnectionManager.getInstance();//wsws ��ȡ���ݿ�ʵ��
                        dbMgr.addConnectionProvider(dsNames[i], cp);

                        // Populate the underlying C3P0 data source pool properties
                        populateProviderWithExtraProps(cp, pp.getUnderlyingProperties());//wsws ???
        ...
        for (int i = 0; i < pluginNames.length; i++) {//wsws properties��û��pluginNames��ִ��0��
        ...
        for (int i = 0; i < jobListenerNames.length; i++) {//wsws properties��û��jobListenerNames��ִ��0��
        ...
        for (int i = 0; i < triggerListenerNames.length; i++) {//wsws properties��û��triggerListenerNames��ִ��0��
        ...
        if (threadExecutorClass != null) {//wsws Ϊ��
