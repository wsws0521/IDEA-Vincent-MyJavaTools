					...
					<tr>
          				...
          				<table style="width: 100%;" border="0" cellspacing="0" cellpadding="0">
            				<tr>
              					...
              					<a href="TriggerSimpleManager.action"><strong>Simple触发器管理>></strong></a>修改Simple触发器>></td>
            				</tr>
            				<tr>
            					            					
              					<td width="100%" height="470" align="center" valign="top" bgcolor="#F6F9FE">
              					
<form name="form1" method="post" action="TriggerSimpleUpdateSave.action" onSubmit="return mycheck()" >
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        ...
        <td title="额外运行次数">
        <input name="REPEAT_COUNT" type="text" class="text2" id="REPEAT_COUNT" value="<s:property value='cnbean.REPEAT_COUNT'/>"
    ...
    <tr>
        ...
        <td ><input name="REPEAT_INTERVAL" type="text" class="text2" id="REPEAT_INTERVAL" value="<s:property value='cnbean.REPEAT_INTERVAL'/>"
        onkeyup="this.value=this.value.replace(/\D/g,'')" >        
